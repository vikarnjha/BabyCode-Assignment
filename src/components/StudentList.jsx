    ...
    <>
      <div className="max-w-md mx-auto p-6 bg-white shadow-lg rounded-xl mt-10">
        ...
        <select
          ...
          className="w-full px-4 py-2 mb-6 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
        >
        ...
        <ul className="space-y-4">
          {filtered.map((student) => (
            ...
            >
              <p className="text-lg font-semibold text-blue-800">Name :- {student.name}
              </p>
